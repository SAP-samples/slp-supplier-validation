			...
			assertions: {
				...
				iShouldSeeTheCharts: function () {
					if (sChartViewName.search("D3") >= 0) {
						this.waitFor({
							controlType: "com.sap.pgp.dev.SupplierControlApp.control.D3PieChart",
							viewName: sChartViewName,
						...
						this.waitFor({
							controlType: "com.sap.pgp.dev.SupplierControlApp.control.D3ColumnChart",
							viewName: sChartViewName,
							success: function (aCharts) {
						...
						this.waitFor({
							controlType: "com.sap.pgp.dev.SupplierControlApp.control.D3ComparisonChart",
							viewName: sChartViewName,
							success: function (aCharts) {
						...
						this.waitFor({
							controlType: "com.sap.pgp.dev.SupplierControlApp.control.D3Chart",
							viewName: sChartViewName,
							success: function (aCharts) {
