sap.ui.define([
	...
	return Control.extend("com.sap.pgp.dev.SupplierControlApp.control.D3Chart", {
		...
		renderer: {
			 ...
			 * @param {com.sap.pgp.dev.SupplierControlApp.control.D3Chart} oControl the control to be rendered
			 */
