sap.ui.define(
  ...
  function (
    ...
    return Controller.extend(
      "com.sap.pgp.dev.SupplierControlApp.controller.Plant2ShipToAddressMap",
      {
        onInit: function () {
          this.getView().setModel(new JSONModel(Device), "device");
          this.getView().setModel(new JSONModel({}), "Plant2ShipToAddressData");
          ...
          const initiatState = {
            ...
            dialogID: "ImportPlant2ShipToAddressDialog",
            popUpTitle: "Import Plant2ShipToAddress",
            messageStrip:
              "Please Load CSV file to bulk import Plant2ShipToAddress data in database.",
          };
        ...
        _handleRouteMatched: function (oEvent) {
          ...
          oDataModel.read("/Plant2ShipToAddress", {
            success: function (oData, response) {
              _this
                .getView()
                .getModel("Plant2ShipToAddressData")
          ...
          AdminModel.create(
            ...
            { entities },
            {
              success: (oRetrievedResult) => {
                MessageToast.show("Plant2ShipToAddress uploaded successfully!");
                this._closeDialog();
              ...
              error: function myErrorHandler(oError) {
                console.log(oError);
                MessageToast.show(
                  "Create Plant2ShipToAddress: Failed to save Configuration"
                );
              },
            }
          );
        ...
        onDownloadFile: function (oEvent) {
          ...
          var fileName = "Plant2ShipToAddress_import_sample.csv";
        ...
        onOpenPlant2ShipToAddressImportDialog: function () {
        ...
        handlePlant2ShipToAddressSearch: function (oEvent) {
          var oTable = this.getView().byId("Plant2ShipToAddressTable");
          if (!oTable) {
