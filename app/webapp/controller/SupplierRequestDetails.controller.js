sap.ui.define(
  ...
  ) 
  {
    ...
    return Controller.extend("com.sap.pgp.dev.SupplierControlApp.controller.SupplierRequestDetails", {
      onInit: function () {
        ...
        var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
            oRouter.getRoute("SupplierRequestDetails").attachPatternMatched(this._onObjectMatched, this);
        
        
      },

      _onObjectMatched: function(oEvent) {
        var sSRID = oEvent.getParameter("arguments").SRID;

        var oFilter = new sap.ui.model.Filter( "SuppRequestID", sap.ui.model.FilterOperator.EQ,`${sSRID}`);

        var oSRModel = new JSONModel();
        oSRModel.setData({SRID: `${sSRID}` });
        this.getView().setModel(oSRModel,"SRModel");
        ...
        oDataModel.read("/SupplierRequest", {
          ...
          success: function (oData, response) {
            ...
            _this.getView().setModel(oJsonModel,"SRData");
          },
     ...
     debugger;
      ...
      OnPressBack: function () {
        ...
        oRouter.navTo("SupplierRequestList", {}, true /*no history*/);
      },
 ...
 OnPressStatus: function (oEvent) {
          ...
          var oModel =  this.getView().getModel("SRModel");
          var SRValue = oModel.getProperty("/SRID");
      ...
      InitiateDocuSign: function (SRID) {
        ...
        var fnError = function (data) {
            console.log("Error in DocuSign Create Envelope");
        }.bind(this);
