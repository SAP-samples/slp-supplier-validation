sap.ui.define(
  ...
  function (
    ...
    return Controller.extend(
      "com.sap.pgp.dev.SupplierControlApp.controller.RegionMap",
      {
        onInit: function () {
          this.getView().setModel(this.getOwnerComponent().getModel("AdminMo"));

          this.getView().setModel(new JSONModel(Device), "device");
          this.getView().setModel(new JSONModel({}), "RegionsData");

          const initiatState = {
            isCategoriesLoading: false,
            dialogID: "ImportRegionsDialog",
            popUpTitle: "Import Regions",
            messageStrip:
              "Please Load CSV file to bulk import Regions data in database.",
          };
        ...
        onStartUpload: function (oEvent) {
          ...
          const payloadData = this.getView().getModel("RegionsData").oData;
          ...
          AdminModel.create(
            ...
            { entities },
            {
              success: (oRetrievedResult) => {
                MessageToast.show("Regions uploaded successfully!");
                this._closeDialog();
              ...
              error: function myErrorHandler(oError) {
                console.log(oError);
                MessageToast.show(
                  "Create Region: Failed to save Configuration"
                );
              },
            }
          );
        ...
        onDownloadFile: function (oEvent) {
          ...
          var fileName = "regions_import_sample.csv";
        ...
        onOpenRegionsImportDialog: function () {
        ...
        handleRegionSearch: function (oEvent) {
          var oTable = this.getView().byId("RegionTable");
          if (!oTable) {
